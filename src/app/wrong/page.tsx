...
export default function WrongPage() {
  ...
  useEffect(() => {
    fetch('/api/practice?wrongOnly=true')
  ...
  return (
    <div className="space-y-4 p-4">
      ...
      {loading ? (
        ...
        <div className="py-12 text-center text-gray-500">暂无错题</div>
      ) : (
      ...
      {questions.length > 0 && (
        <Button className="w-full" onClick={() => router.push('/practice?wrongOnly=true')}>
          开始练习错题
        </Button>
      )}
    </div>
